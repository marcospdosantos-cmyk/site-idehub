...
<div class="card">
    <div class="actions" style="justify-content:space-between;margin-bottom:14px">
        <p class="muted">Catalogo exibido no frontend.</p>
        <a class="btn btn-primary" href="<?= e(app_url('/admin/products/create.php')) ?>">Novo produto</a>
    </div>
    <div class="table-wrap">
        <table>
            <thead><tr><th>Imagem</th><th>Produto</th><th>Categoria</th><th>Preco</th><th>Estoque</th><th>Status</th><th></th></tr></thead>
            <tbody>
            <?php foreach ($products as $product): ?>
                <tr>
                    <td><?php if ($product['image_path']): ?><img class="thumb" src="<?= e(upload_url($product['image_path'])) ?>" alt=""><?php endif; ?></td>
