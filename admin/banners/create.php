...
$admin = require_admin();
$error = null;
$banner = ['title' => '', 'subtitle' => '', 'link_url' => '', 'display_order' => 0, 'active' => 1];
...
<form class="card" method="post" enctype="multipart/form-data">
    <?= csrf_field() ?>
    <div class="form-row"><label>Imagem</label><input type="file" name="image" required accept="image/jpeg,image/png,image/webp,image/gif"></div>
