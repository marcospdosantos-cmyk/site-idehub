...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($active && Banner::activeCount($id) >= 3) {
            throw new RuntimeException('O site usa no máximo 3 banners ativos. Desative um banner antes de ativar este.');
        }
...
$pageSubtitle = 'Atualize imagem, texto, link e ordem do destaque.';
...
<form class="card" method="post" enctype="multipart/form-data">
    ...
    <div class="form-row"><label>Imagem</label><input type="file" name="image" accept="image/jpeg,image/png,image/webp,image/gif"><p class="muted">Atual: <?= e($banner['image_path']) ?>. Use imagens horizontais; o site recorta automaticamente para manter altura fixa.</p></div>
