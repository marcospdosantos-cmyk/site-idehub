...
VALUES
('/image/imgi_18.webp', 'Vista sua fé.', 'Vista a mensagem. Carregue a presença.', 'Camisetas cristãs para quem quer representar Jesus com estilo, verdade e atitude no dia a dia.', 'Peças limitadas. Chame antes que esgote!', 'Comprar pelo WhatsApp', 'Ver coleção', 'Coleção ativa', 'Fé, identidade e estilo na mesma peça.', 'Escolha sua camiseta, confirme os detalhes e finalize com atendimento direto.', NULL, 1, 1),
('/image/Jesus Way Preto 1.webp', 'Coleção Ide.hub', 'Jesus no centro.', 'Peças para jovens cristãos que querem se vestir bem sem esconder aquilo em que acreditam.', 'Compra simples, conversa direta e confirmação antes do pagamento.', 'Escolher minha camiseta', 'Tirar dúvidas', 'Coleção ativa', 'Escolha com calma. A gente te ajuda no WhatsApp.', 'Antes de finalizar, confirmamos modelo, tamanho, cor e disponibilidade.', NULL, 2, 1),
('/image/Boas Novas 1.webp', 'Para quem quer representar Jesus com estilo.', 'Mostre o que te move.', 'Roupas cristãs com visual urbano, mensagens fortes e acabamento pensado para a rotina.', 'Atendimento humanizado para você comprar com segurança e sem complicação.', 'Chamar no WhatsApp', 'Conhecer a coleção', 'Coleção ativa', 'Estilo que aponta para Cristo.', 'Navegue pelas peças e escolha a que combina com seu estilo e caminhada.', NULL, 3, 1);
